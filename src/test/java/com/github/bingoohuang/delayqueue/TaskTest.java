...
public class TaskTest {
  @Autowired
  @Qualifier("springTaskRunner")
  TaskRunner taskRunner;

  @Autowired
  @Qualifier("taskRunner2")
  TaskRunner taskRunner2;

  @Autowired Jedis jedis;

  @Autowired
  @Qualifier("springTaskConfig")
  ...
  public void getSpringBeanDefaultName() {
    assertThat(TaskUtil.getSpringBeanDefaultName(MyTaskable.class)).isEqualTo("myTaskable");
  ...
  public void fireAgain() {
    ...
    val vo =
        TaskItemVo.builder()
            .taskId("FIRE_AGAIN_110")
            .taskName("测试任务")
            .taskServiceClass(FireAgainTaskable.class)
            .relativeId("关联ID")
            .build();
    ...
    Set<String> set =
        jedis.zrange(taskConfig.getQueueKey().apply(task.getRunAt().getMillis()), 0, -1);
  ...
  public void submit() {
    ...
    val attachment =
        AttachmentVo.builder()
            ...
            .createTime(
                DateTime.parse(
                    "2018-07-19 11:02:17", DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss")))
            .build();
    val vo =
        TaskItemVo.builder()
            .taskId("110")
    ...
    Set<String> set =
        jedis.zrange(taskConfig.getQueueKey().apply(System.currentTimeMillis()), 0, -1);
    assertThat(set).contains(task.getTaskId());

    taskRunner.fire();
    set = jedis.zrange(taskConfig.getQueueKey().apply(System.currentTimeMillis()), 0, -1);
    ...
    assertThat(item.getAttachmentAsString())
        .isEqualTo("{\"createTime\":\"2018-07-19 11:02:17.000\",\"name\":\"黄进兵\",\"age\":110}");
    ...
    val vo2 =
        TaskItemVo.builder()
            .taskId("20002000")
            .taskName("测试任务")
            .taskServiceClass(MyTaskable.class)
            .build();
  ...
  public void timeout() {
    val vo =
        TaskItemVo.builder()
            .taskId("310")
            .taskName("测试任务")
            .taskServiceClass(MyTimeoutTaskable.class)
            .timeout(1)
            .build();
    taskRunner.submit(vo);
    taskRunner.fire();
  ...
  public void timeout3() {
    val vo =
        TaskItemVo.builder()
            .taskId("330")
            .taskName("测试任务")
            .taskServiceClass(MyExTaskable.class)
            .timeout(2)
            .build();
    taskRunner.submit(vo);
    taskRunner.fire();
  ...
  @Test
  public void delay() {
    jedis.del(taskConfig.getQueueKey().apply(System.currentTimeMillis()));
    taskRunner.fire();
    ...
    Set<String> set =
        jedis.zrangeByScore(
            taskConfig.getQueueKey().apply(System.currentTimeMillis()),
            0,
  ...
  public void invokeDirect() {
    ...
    val vo =
        TaskItemVo.builder()
            .taskId(taskId)
            .taskName("测试任务")
            .taskServiceClass(MyInvokeTaskable.class)
            .build();
